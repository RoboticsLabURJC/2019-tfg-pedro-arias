...
Previo paso a las secciones del capítulo, se presentan en la Figura \ref{fig:esquema-general} un esquema general que representa la arquitectura del sistema. El esquema muestra tanto el hardware como el software que integra el sistema, y da una visón global inicial del funcionamiento de la aplicación dentro del sistema.
