...
La aeronave real puede ser de diversa índole, como ya se ha visto en el capítulo anterior. A lo largo de este proyecto se prevé utilizar las siguientes aeronaves:
...
Existen un tipo especial de mensajes que encapsulan a los comandos, órdenes a ejecutar por la aeronave. Los comandos pueden ser de tres tipos, de navegación, de acción y de condición. Los comandos utilizados en el protocolo se pueden comprobar también en la documentación de MAVLink \cite{mavlink-msg}. Un ejemplo de comando MAVLink se puede observar en el Código \ref{listing:cmd-exp}.
