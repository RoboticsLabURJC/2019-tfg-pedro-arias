...
Además, el Apéndice \ref{} recoge una tabla que esquematiza cada uno de los casos de uso. Junto a las tablas se añaden una serie de diagramas de caso de uso que tratan de ejemplificar la interacción entre el usuario y la aplicación para cada caso. \\
...
El primer caso de uso describe una situación en la que un operario cualquiera desee caracterizar una aeronave y su carga de pago mediante la introducción de sus parámetros en la aplicación. La tabla con el caso de uso se presenta en el Apéndice \ref{}. \\
...
En este caso de uso se explica el proceso de carga de un mapa local mostrando una posición determinada en la aplicación. En el Apéndice \ref{} se muestra una tabla que recoge el caso de uso. \\
...
Este caso de uso prueba las acciones necesarias para la creación y posterior guardado de una misión polilínea. El Apéndice \ref{} recoge el caso de uso simplificado en una tabla. \\
...
El cuarto caso de uso explica el procedimiento a seguir para establecer la conexión entre la aeronave y la estación de tierra. Se agrega en el Apéndice \ref{} una tabla resumen y simplificada de lo que en esta sección se describe. \\
...
Con caso de uso se presenta también una tabla en el Apéndice \ref{} que recoge sus principales aspectos. La secuencia normal de ejecución es la siguiente:
...
En el Apéndice \ref{} se presenta este caso de uso en formato de tabla con los principales aspecto esquematizados. La secuencia normal de ejecución es la siguiente:
...
Este caso de uso se presenta en formato de tabla en el Apéndice \ref{}. La secuencia de ejecución en condiciones normales es la siguiente:
...
Finalmente, el último caso de uso presentado muestra como cambiar dinámicamente el idioma del texto de la aplicación. La aplicación debe estar abierta y en ejecución. El Apéndice \ref{} incluye una tabla con el caso de uso esquematizado. La secuencia de ejecución en condiciones normales es la siguiente:
